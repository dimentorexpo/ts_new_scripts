...
chrome.storage.local.get(['TS_addr', 'KC_addr', 'TP_addr', 'KC_addrRzrv', 'TP_addrRzrv'], function(data) {
    ...
    // Теперь у вас есть доступ к этим переменным
    console.log(TS_addr);
    console.log(KC_addr);
    console.log(TP_addr);
    console.log(KC_addrRzrv);
    console.log(TP_addrRzrv);
});
