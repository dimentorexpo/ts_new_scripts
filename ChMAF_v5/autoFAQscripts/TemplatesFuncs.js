var nameContainer = '';
 var win_UsersInfo = // описание окна тестовых пользователей
    `<span style="display: block;">
        ...
        <button class="mainButton" id="CurUsChatHisWA" title="Открыть историю чатов WA обратившегося пользователя" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left:-8px"><img src="/Images/WA.png" alt="Поиск обращений в WA" width="20" height="20" vertical-align="top"></button>
