        ...
        <span>
			<span style="cursor: -webkit-grab;">
				<div style="margin: 5px;" id="1str">
					...
					<button class="mainButton buttonHide" id="hideMenuMain" title="Скрывает расширение и др открытых окон" style="margin-left:10px; width: 160px">Скрыть</button>
                    ...
                    right: 178px;    z-index: 9999999;    user-select: none;    -webkit-user-drag: none;    background: darkred;    border: 1px solid black;">
				</div>
