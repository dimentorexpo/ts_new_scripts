...
var win_UsersInfo = // описание окна тестовых пользователей
    ...
    <button class="mainButton" id="CurUsChatHisWA" title="Открыть историю чатов WA обратившегося пользователя" style="cursor: pointer; width: 30px; height: 30px; font-size: 15px; margin-left:-8px"><img src="chrome-extension://apfpohhjoaonchmnjabidbffmbgcfjci/Images/WA.png" alt="Поиск обращений в WA" width="20" height="20" vertical-align="top"></button>
