...
<div style="display: flex; width: 400px;">
    <span style="width: 400px">
        <span style="cursor: -webkit-grab;">
            <div style="margin: 5px; width: 400px; display:flex; align-items:center; gap:4px;" id="OpSt_header">
                <button class="buttonHide" title="скрывает меню" id="hideMeOpSt">${_os_close} hide</button>
                <span style="margin-left:auto; display:flex; align-items:center; gap:4px;">
                    <span style="color:#c9a84c;">${_os_users}</span>
                    <button class="btnCRM btnCRMsmall" id="clearopersinfo" style="display:flex; align-items:center; gap:4px;">${_os_broom}</button>
                </span>
            </div>
        </span>
